...
public class QQFriendList extends JFrame implements ActionListener,MouseListener{
	...
	public static void main(String[] args) {
	 ...
	 QQFriendList qqFriendList=new QQFriendList("hh");
	}
	...
	public QQFriendList(String ownerId)
	{
		...
		{
			jb1s[i]=new JLabel(i+1+"",new ImageIcon("image/QQ.png"),JLabel.LEFT);
		...
		getContentPane().add(jphy1,"1");
		getContentPane().add(jpmsr1,"2");
		//在窗口显示自己的编号.
